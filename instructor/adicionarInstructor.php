...
<head>
	<meta charset="UTF-8">
	<title>Adicionar Instructor</title>
        ...
        <div class="ui small form segment">
             <h2>Adicionar Instructor</h2>
                 <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="field">
                        <label>Rol</label>
                        <input value="Instructor" type="text" name="rol_usuario" readonly="readonly">
                      </div>
                      <div class="field">
                        <label>Estado</label>
                    ...
                    <div class="ui buttons">
                        <a href="listarInstructor.php" class="ui green button">Cancelar</a>
                        <div class="or"></div>
